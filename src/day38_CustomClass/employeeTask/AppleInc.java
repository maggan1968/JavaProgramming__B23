...
public class AppleInc {
    ...
    public static void main(String[] args) {
        ...
        employee1.setInfo("Karina", 'F', 11, "SDET", 160000);

        Employee employee2 = new Employee();
        employee2.setInfo("Abbos", 'M', 12, "QA", 150000);

        Employee employee3 = new Employee();
        employee3.setInfo("Tugba",'F',13,"SDET", 140000);

        Employee employee4 = new Employee();
        employee4.setInfo("Fhilipp",'M',21,"Scrum Master",130000);

        Employee employee5 = new Employee();
        employee5.setInfo("Ella", 'F', 14,"QA",85000);
